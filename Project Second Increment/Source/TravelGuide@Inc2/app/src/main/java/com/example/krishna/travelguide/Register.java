package com.example.krishna.travelguide;
...
import domain.krishna.travelguide.beans.User;

public class Register extends AppCompatActivity {

    public static String USER = "domain.krishna.travelguide.USER";
    public static String NAME = "domain.krishna.travelguide.NAME";
    public static String EMAIL = "domain.krishna.travelguide.EMAIL";
    public static String PASSWORD = "domain.krishna.travelguide.PASSWORD";
    public static String PHONE = "domain.krishna.travelguide.PHONE";
    @Override
