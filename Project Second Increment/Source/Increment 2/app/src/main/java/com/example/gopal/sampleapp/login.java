package com.example.gopal.sampleapp;
    ...
    private void Login(View view)
    {
        try
        {
           ...
           final UserDetails objUser = new UserDetails();
            ...
            String URL = "https://api.mlab.com/api/1/databases/krishna/collections/krishna?q={%22EMailID%22:%22"+urlEncodedName+"%22}&apiKey=ZI6VVbMYwfOCggNnh7mjlRgMqZbaZhXA";
