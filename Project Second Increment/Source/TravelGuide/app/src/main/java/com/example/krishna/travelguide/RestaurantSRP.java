...
import domain.krishna.travelguide.beans.Constants;
import domain.krishna.travelguide.beans.RestaurantResult;
import domain.krishna.travelguide.beans.Venue;

public class RestaurantSRP extends AppCompatActivity {

    public static String USER = "domain.krishna.travelguide.USER";
    public static String CATEGORY = "domain.krishna.travelguide.CATEGORY";
