package domain.krishna.cityguide;
...
import domain.krishna.cityguide.beans.User;

public class Register extends AppCompatActivity {

    public static String USER = "domain.krishna.cityguide.USER";
    public static String NAME = "domain.krishna.cityguide.NAME";
    public static String EMAIL = "domain.krishna.cityguide.EMAIL";
    public static String PASSWORD = "domain.krishna.cityguide.PASSWORD";
    public static String PHONE = "domain.krishna.cityguide.PHONE";
    @Override
