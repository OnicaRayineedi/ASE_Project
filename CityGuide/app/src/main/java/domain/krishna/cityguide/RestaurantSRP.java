...
import domain.krishna.cityguide.beans.Constants;
import domain.krishna.cityguide.beans.RestaurantResult;
import domain.krishna.cityguide.beans.Venue;

public class RestaurantSRP extends AppCompatActivity {

    public static String USER = "domain.krishna.cityguide.USER";
    public static String CATEGORY = "domain.krishna.cityguide.CATEGORY";
